...
// node_modules/@mui/material/utils/useSlot.js
var _excluded8 = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"];
...
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded8);
  const {
...
var Avatar = React25.forwardRef(function Avatar2(inProps, ref) {
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime8.jsx)(ImgSlot, _extends({}, imgSlotProps));
  ...
  return (0, import_jsx_runtime8.jsx)(AvatarRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
@mui/utils/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MWWU75M4.js.map
