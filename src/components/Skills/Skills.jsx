...
import re from "./img1.png"
import pe from "./img2.png"
import ke from "./img3.png"
import ce from "./img4.png"
import Left from "./Left";
import Right from "./Bom";
...
function SKills(){
    return(
        <div><div className="flex flex-col mt-[6rem] md:ml-[9rem]"> 
            <div className="text-white text-[3rem] flex justify-center">SKILLS</div>
            <div className="flex justify-center mt-[4rem]">
            <AvatarGroup max={5}>
                <Avatar alt="Remy Sharp" src={re} />
                <Avatar alt="Travis Howard" src={pe} />
                <Avatar alt="Cindy Baker" src={ke} />
                <Avatar alt="Agnes Walker" src={ce} />
            </AvatarGroup>
            </div>
            <div className="flex flex-col justify-between md:flex-row ">
               <Left>
                <p className="text-white ml-[0.25rem]">React</p>
                <div className="progress  ">
                    
                    <div class="progress-value"></div>
                </div>
                <p className="text-white mt-[4rem] ml-[0.25rem]">React</p>
                <div className="progress ">
                ...
                <div className="progress1  ">
                    ...
                    <div className="progress1-value"></div>
                </div>
                <p className="text-white mt-[4rem] ml-[0.25rem]">React</p>
                <div className="progress1 ">
                    <div className="progress1-value"></div>
        ...
        <div className="flex overflow-hidden space-x-16 group mt-[10rem] bg-[#FFC3B9] w-[100%]">
